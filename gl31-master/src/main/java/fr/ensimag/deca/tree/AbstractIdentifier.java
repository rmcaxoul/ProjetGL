...
public abstract class AbstractIdentifier extends AbstractLValue {
    ...
    /**
     * General assembly code, to declare a new variable
     * @param compiler 
     */
    ...
    /**
     * General assembly code, to declare a new variable inside a method, use LB pile
     * @param compiler
     */
    public abstract void codeGenDeclVarMeth(DecacCompiler compiler);
